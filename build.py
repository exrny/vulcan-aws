...
import os
import sys
from exr.builder import task, nsh
import sh
...
def update_version(ver=None):
    with open('exr/meta_aws.py', 'r') as f:
        file_str = f.read()
    ...
    with open('exr/meta_aws.py', 'w') as f:
        f.write(file_str)

    nsh.git('commit', 'exr/meta_aws.py', '-m',
...
def create_tag():
    ...
    if m:
        ...
        raise "Can't find/parse current version in './exr/meta_aws.py'"
